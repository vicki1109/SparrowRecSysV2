...
def classify(datapath_train, datapath_test, steps, modelpath):
    ...
    def normalizersctr(x):
        ...
        # return tf.cond(tf.greater(x, 400.0), lambda: 1.0, lambda: x/400.0)
        # if x >= 400:
        #     return 1.0
        # else:
        #     return x/400.0
    ...
    tagid = tf.feature_column.categorical_column_with_hash_bucket(key="tagid", hash_bucket_size=5000)
